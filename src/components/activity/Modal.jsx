    ...
    const data = [
        {
            ...
            description: ['As a new service developer, I contributed to projects such as GemOfYourSoul and Larngear Passport.',
                'Gained valuable experience working in team environments, collaborating with others on project goals.',
            ],
        ...
        },
        {
            ...
            description: ['As the Head of Planning, I organized Baan Jijah in Rubpuenkaomai 2024, an activity welcoming over 200 freshmen to the university.',
                'Led a team of 6 members, overseeing the creation of the timing plan, managing locations, and organizing the Bai Sri (traditional Thai blessing ceremony).'
            ],
        ...
        },
        {
            ...
            description: ['As part of the planning team for Larngear23, I contributed to organizing the event by managing timing schedules and locations.', 'This experience taught me how to work collaboratively and organize tasks effectively with others.'],
        ...
        },
        {
            ...
            tags: ['Dancing', 'Hobby', 'T-pop', 'K-pop'],
            viewMore: [
                {
                    title: 'StepOut',
